...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar p-3">
            ...
            <a href="listeEmployeIndex.php" class="active"><i class="bi bi-people"></i> employes</a>
        ...
        <main class="col-md-10 p-4">
            ...
            <h3 class="mb-4">
                <i class="bi bi-people"></i> Liste des employes
            </h3>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-primary bi bi-pencil">
                                        <a style=" text-decoration: none; color: white;" href="modifier_employe.php?id_user=<?= $ep['id_user']?>" >
                                            modifier
                                        </a>
                                    </button>
...
<script>
    ...
    window.location.href="modifier_employe.php?id_user=<?= $ep['id_user']?>";
